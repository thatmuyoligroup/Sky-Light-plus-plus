    ...
    howToUse: [
        {
            ...
            item: [{
                ...
                item: [
                    {
                        title: '地图烛火点',
                        type: 'itemFloat',
                        content: `点击地图烛火点展开所有地图；<br/>
                                    点击地图左侧复选框即可全选该图所有烛火点，再次点击即可取消全选；<br/>
                                    点击地图展开所有小图，双击小图按钮可选择小图所有烛火，再次双击小图即可取消；<br/>
                                    单击小图可选择具体烛火点<br/>
                        `,
                    },
                    {
                        title: '特别烛火',
                        type: 'itemFloat',
                        content: `点击即可选择，再次点击即可取消选择；<br/>部分还可以选择具体数量
                        `,
                    },
                    {
                        title: '烛火收获点',
                        type: 'itemFloat',
                        content: `点击即可选择，再次点击即可取消选择；<br/>`,
                    },
                    {
                        title: '活动烛火',
                        type: 'itemFloat',
                        content: `有活动的时候才会展示<br/>点击即可选择，再次点击即可取消选择；<br/>`,
                    }
                ]
            }, {
                title: '查看分析',
                ...
                item: [{
                    title: '总览',
                    type: 'itemFloat',
                    content: `当你选择了烛火后，会自动进行结果分析，下滑到底部可以查看总览结果
                        `,
                }, {
                    title: '烛火进度',
                    type: 'itemFloat',
                    content: `当你选择了烛火后，会自动进行结果分析，下滑到底部可查看选择的/未选择的烛火详情<br/>
                        `,
                }, {
                    title: '预测',
                    type: 'itemFloat',
                    content: `当存在分析结果时，可进行预测<br/>
                            合成进度参考图：
                    ...
                    title: '清空',
                    type: 'itemFloat',
                    content: `点击下方按钮清空按钮可快速将选择的烛火清除;<br/>
                        分析预测的结果也将一并清空
                        `,
                }],
            }, {
                ...
                item: [
                    {
                        title: '导出',
                        type: 'itemFloat',
                        content: `当你想要将选择的烛火方案共享给其他人或自己保存以便下次查看;<br/>可直接点击底部导出按钮，导出成功会自动复制到剪切板，你可直接复制保存
                    ...
                    },
                    {
                        title: '导入',
                        type: 'itemFloat',
                        content: `当你想要查看已有的方案或他人共享的方案，可点击下方导入按钮并复制方案;<br/>
                        复制到文本框后，点击确认，导入成功后会自动产生分析结果
                        `,
                    }
                ],
            }],
